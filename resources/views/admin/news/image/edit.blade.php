...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="quickForm" method="POST" action="{{Url('/admin/news/image/update')}}" enctype="multipart/form-data" >
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="image_file" class="form-control" id="image_file" value="<?= $image->image_file; ?>"/>
                    </div>
                    <div class="form-group">

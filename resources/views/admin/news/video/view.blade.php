        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <div class="category-details ml-3 mt-3">
                    <h5>Video</h5>
                    <hr />
                    <p><iframe width="320" height="280" src="<?= $video->video_link; ?>" frameborder="0" allowfullscreen></iframe></p>
                </div>
                <div class="category-details ml-3">
                    <h5>Video Thumbnail</h5>
                    <hr />
                    <p><img src="<?= str_replace('/public', '', $video->video_thumbnail);?>" width="320" height="280" alt=""></p>
                </div>
                <div class="category-details ml-3">
                    <h5>Sort Order</h5>
                    <hr />

...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form enctype="multipart/form-data" id="quickForm" method="POST" action="{{Url('/admin/news/video/create')}}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="date_time" class="form-control" id="date_time" placeholder="Date Time">
                    </div>
                    <div class="form-group">
